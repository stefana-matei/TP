...
int main(void)
{
	...
	printf("dimensiune union: %d\n", sizeof(union int_sau_double));
	  ...
	  daca atribuim valoare_stocata campului int, valoarea campului double devine nespecificata.
	u.n = -101;
	printf("%d %lg\n", u.n, u.d);

	  daca atribuim valoare_stocata campului double, valoarea campului int devine nespecificata.
	u.d = 77.12;
	printf("%d %lf\n", u.n, u.d);

/*P1. Realizati urmatoarea aplicatie care foloseste  uniuni.*/
...
int main()
{
	// declar o variabila de tipul uniunii definite anterior ce va avea ca dimensiune maximul dintre dimens. campurilor
	union intreg_real  u;
